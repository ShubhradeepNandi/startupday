...
## Lab Instructions
Create a NodeRed application and add Alchemy API Service to it.  
![ScreenShot](images/fe_create_service.png)

On your Node-RED application click on "Add a Service or API"
...
The flows for this lab are here -> [flows](code.json)
